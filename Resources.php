...
<section id="resorces_content" class="resorces_content resource-onlyy">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
                <div class="inner_resouces_list">
                    <ul>
                        <li>
                            <div class="list_webnair"> 
                                <div class="list_image">
                                    <img src="assets/webinar.png" alt="img">
                                </div>
                            ...
                            <div class="list-btnn">
                                <a href="#">Upcoming Webinars <svg width="13" height="12" viewBox="0 0 13 12"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M1 5.50163C0.632731 5.50163 0.335 5.79936 0.335 6.16663C0.335 6.5339 0.632731 6.83163 1 6.83163V5.50163ZM11.4713 5.50163H1V6.83163H11.4713V5.50163Z"
                                            fill="#0041BE"></path>
                                        <path
                                            d="M6.53906 10.9997C6.61436 10.9324 6.68996 10.8626 6.76646 10.7907C8.72461 8.887 10.6828 7.01159 11.3374 6.38557C11.462 6.26641 11.4614 6.06835 11.3356 5.95038C10.6642 5.3204 8.63479 3.4102 6.67001 1.5"
                                            stroke="#0041BE" stroke-width="1.33" stroke-miterlimit="10"
                        ...
                        <li>
                            <div class="list_webnair">
                                <div class="list_image">
                                    <img src="assets/tax_alert.png" alt="img">
                                </div>
                                <div class="list_content">
                                    <h2>Tax Alerts</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                            ...
                            <div class="list-btnn">
                                <a href="#">See Tax Alerts <svg width="13" height="12" viewBox="0 0 13 12" fill="none"
                        ...
                        <li>
                            <div class="list_webnair">
                                <div class="list_image">
                                    <img src="assets/whitepaper.png" alt="img">
                                </div>
                                <div class="list_content">
                                    <h2>WhitePapers & Case Studies</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt ut labore et dolore magna aliqua.</p>
                                </div>
                            </div>
                            <div class="list-btnn">
                                <a href="#">See All <svg width="13" height="12" viewBox="0 0 13 12" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M1 5.50163C0.632731 5.50163 0.335 5.79936 0.335 6.16663C0.335 6.5339 0.632731 6.83163 1 6.83163V5.50163ZM11.4713 5.50163H1V6.83163H11.4713V5.50163Z"
                                            fill="#0041BE"></path>
