...
<section id="tax_alerts" class="tax_alerts">
    <div class="container">
        <div class="row">

            <div class="col-sm-6">
                <div class="inner_resouces">
                    <h2>Tax Alerts</h2>
                    <h3>Government of Rajasthan notifies the Amnesty Scheme, 2025, for settlement of pre-GST dues</h3>
                    <span>20 Feb 2025, 8:00pm</span>
            ...
            <div class="col-sm-6">
                <div class="inner_resouces-right">
                    <div class="filter_inn">
                        ...
                        <div class="right_sortflt">
                            <svg width="16" height="10" viewBox="0 0 16 10" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M0.5 0.833333C0.5 0.61232 0.587797 0.400358 0.744078 0.244078C0.900358 0.0877975 1.11232 0 1.33333 0H14.6667C14.8877 0 15.0996 0.0877975 15.2559 0.244078C15.4122 0.400358 15.5 0.61232 15.5 0.833333C15.5 1.05435 15.4122 1.26631 15.2559 1.42259C15.0996 1.57887 14.8877 1.66667 14.6667 1.66667H1.33333C1.11232 1.66667 0.900358 1.57887 0.744078 1.42259C0.587797 1.26631 0.5 1.05435 0.5 0.833333ZM2.16667 4.58333C2.16667 4.36232 2.25446 4.15036 2.41074 3.99408C2.56702 3.8378 2.77899 3.75 3 3.75H13C13.221 3.75 13.433 3.8378 13.5893 3.99408C13.7455 4.15036 13.8333 4.36232 13.8333 4.58333C13.8333 4.80435 13.7455 5.01631 13.5893 5.17259C13.433 5.32887 13.221 5.41667 13 5.41667H3C2.77899 5.41667 2.56702 5.32887 2.41074 5.17259C2.25446 5.01631 2.16667 4.80435 2.16667 4.58333ZM4.66667 8.33333C4.66667 8.11232 4.75446 7.90036 4.91074 7.74408C5.06702 7.5878 5.27899 7.5 5.5 7.5H10.5C10.721 7.5 10.933 7.5878 11.0893 7.74408C11.2455 7.90036 11.3333 8.11232 11.3333 8.33333C11.3333 8.55435 11.2455 8.76631 11.0893 8.92259C10.933 9.07887 10.721 9.16667 10.5 9.16667H5.5C5.27899 9.16667 5.06702 9.07887 4.91074 8.92259C4.75446 8.76631 4.66667 8.55435 4.66667 8.33333Z"
                                    fill="#303030" />
                            </svg>
                            <span>Filters</span>
                        </div>
                    </div>
                    <div class="more_alter">
                        <h2>More Alerts</h2>
                        <ul>
                            <li>
                                <h3>Government of Rajasthan notifies the Amnesty Scheme, 2025, for settlement of pre-GST
                                    dues</h3>
