...
<section id="ai_coman_bannere" class="ai_coman_bannere industry-banner industry-detailed-banner industry-sectordetailed-banner">
        ...
        <div class="container">
            <div class="inner_ai_text">
                <div class="btm_content">
                    <p>Industries > Aerospace & Defense > Sector 1</p>
                </div>
                <h2>Sector 1</h2>
            </div>
        </div>
