...
<head>
    ...
    <meta name="keywords" content="taxable income calculator,income and tax calculator,calculator for tax,online tds payment,calculate salary,in hand salary calculator,new tax regime calculator,hra calculator
">
    <meta name="description" content="Income Tax Calculator - Learn How to Calculate Income Tax Online for FY 2023-24 (AY 2024-25) with plutusco  Income Tax Calculator
">
    ...
    <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
    <title>Income Tax Calculator FY 2024-25 for Income Tax Calculation 
</title>
...
<body>
        ...
        <div class="container calculation_top">
            <div class="d-flex flex-column">
                <div class="d-flex  align-items-center common_links_service">
                    ...
                    <p>></p>
                    <a class="blod_text" href="#"> Income Tax Calculator</a>
                </div>
                <div class="d-flex align-items-center calculator_head">
                    <h1 style="color:  rgba(66, 66, 65, 1);">Income Tax Calculator</h1>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row calculator-container incum-container">
            <div class="col-lg-6 cal_left_div">
               <div class="input-section">
    <div class="section" id="incomeSection" style="margin-top:0";>
        <h3>Income</h3>
        <div class="section-content">
            <div class="input-group">
                <label class="range-label">Salary Income:</label>
                <div class="range_slide">
                    <input type="range" class="range-slider" id="salaryIncome" min="0" max="5000000" value="0" step="10000" oninput="updateValue('salaryIncome')">
                </div>
                <div class="range_input">
                    <input type="number" id="salaryIncomeValue" class="slider-value" value="0" oninput="syncSlider('salaryIncome')">
                </div>
            </div>
            <div class="input-group">
                <label class="range-label">Other Income: </label>
                <div class="range_slide">
                    <input type="range" class="range-slider" id="otherIncome" min="0" max="1000000" value="0" step="10000" oninput="updateValue('otherIncome')">
                </div>
                <div class="range_input">
                    <input type="number" id="otherIncomeValue" class="slider-value" value="0" oninput="syncSlider('otherIncome')">
                </div>
            </div>
            <div class="input-group">
                <label class="range-label">Interest Income: </label>
                <div class="range_slide">
                    <input type="range" class="range-slider" id="interestIncome" min="0" max="500000" value="0" step="10000" oninput="updateValue('interestIncome')">
                </div>
                <div class="range_input">
                    <input type="number" id="interestIncomeValue" class="slider-value" value="0" oninput="syncSlider('interestIncome')">
                </div>
            </div>
            <div class="input-group">
                <label class="range-label">Rental Income: </label>
                <div class="range_slide">
                    <input type="range" class="range-slider" id="rentalIncome" min="0" max="1000000" value="0" step="10000" oninput="updateValue('rentalIncome')">
                </div>
                <div class="range_input">
                    <input type="number" id="rentalIncomeValue" class="slider-value" value="0" oninput="syncSlider('rentalIncome')">
                </div>
            </div>
        </div>
    </div>

    <div class="section" id="deductionsSection">
        <h3>Deductions</h3>
        <div class="section-content" style="display:none;">
            <div class="input-group">
                <label class="range-label">Section 80C: </label>
                <div class="range_slide">
                    <input type="range" class="range-slider" id="deduction80C" min="0" max="150000" value="0" step="1000" oninput="updateValue('deduction80C')">
                </div>
                <div class="range_input">
                    <input type="number" id="deduction80CValue" class="slider-value" value="0" oninput="syncSlider('deduction80C')">
                </div>
            </div>
            <div class="input-group">
                <label class="range-label">NPS Contribution: </label>
                <div class="range_slide">
                    <input type="range" class="range-slider" id="contributionNPS" min="0" max="50000" value="0" step="1000" oninput="updateValue('contributionNPS')">
                </div>
                <div class="range_input">
                    <input type="number" id="contributionNPSValue" class="slider-value" value="0" oninput="syncSlider('contributionNPS')">
                </div>
            </div>
            <div class="input-group">
                <label class="range-label">Medical Insurance: </label>
                <div class="range_slide">
                    <input type="range" class="range-slider" id="medicalInsurance" min="0" max="25000" value="0" step="1000" oninput="updateValue('medicalInsurance')">
                </div>
                <div class="range_input">
                    <input type="number" id="medicalInsuranceValue" class="slider-value" value="0" oninput="syncSlider('medicalInsurance')">
                </div>
            </div>
        </div>
    </div>

    <div class="section" id="hraSection">
        <h3>HRA Exemption</h3>
        <div class="section-content" style="display:none;">
            <div class="input-group">
                <label class="range-label">Basic Salary: </label>
                <div class="range_slide">
                    <input type="range" class="range-slider" id="basicSalary" min="0" max="500000" value="0" step="10000" oninput="updateValue('basicSalary')">
                </div>
                <div class="range_input">
                    <input type="number" id="basicSalaryValue" class="slider-value" value="0" oninput="syncSlider('basicSalary')">
                </div>
            </div>
            <div class="input-group">
                <label class="range-label">DA Received: </label>
                <div class="range_slide">
                    <input type="range" class="range-slider" id="daReceived" min="0" max="100000" value="0" step="1000" oninput="updateValue('daReceived')">
                </div>
                <div class="range_input">
                    <input type="number" id="daReceivedValue" class="slider-value" value="0" oninput="syncSlider('daReceived')">
                </div>
            </div>
            <div class="input-group">
                <label class="range-label">HRA Received: </label>
                <div class="range_slide">
                    <input type="range" class="range-slider" id="hraReceived" min="0" max="100000" value="0" step="1000" oninput="updateValue('hraReceived')">
                </div>
                <div class="range_input">
                    <input type="number" id="hraReceivedValue" class="slider-value" value="0" oninput="syncSlider('hraReceived')">
                </div>
            </div>
            <div class="input-group">
                <label class="range-label">Rent Paid:</label>
                <div class="range_slide">
                    <input type="range" class="range-slider" id="totalRentPaid" min="0" max="50000" value="0" step="1000" oninput="updateValue('totalRentPaid')">
                </div>
                <div class="range_input">
                    <input type="number" id="totalRentPaidValue" class="slider-value" value="0" oninput="syncSlider('totalRentPaid')">
                </div>
            </div>
        </div>
    </div>
...
<div class="result-section">
    ...
    <div class="two_bomtm">
        <div class="fadee new-fade">
            <h2>Tax Savings (HRA Exemption):</h2>
            <span id="taxSavings">₹ 0</span>
        </div>
    </div>
</div>
            </div>
...
// Toggle the dropdown content with slideToggle effect using jQuery
$(".section h3").on("click", function() {
  // Close all sections except the one clicked
  $(".section-content").not($(this).next()).slideUp(); // Hide all sections
  $(this).next(".section-content").slideToggle(); // Toggle the clicked one
});

// Real-time value update for range inputs
...
// Calculate total tax
function calculate() {
  const salaryIncome = parseFloat(document.getElementById("salaryIncome").value);
  ...
  const contributionNPS = parseFloat(document.getElementById("contributionNPS").value);
  const medicalInsurance = parseFloat(document.getElementById("medicalInsurance").value);

  const basicSalary = parseFloat(document.getElementById("basicSalary").value);
  const daReceived = parseFloat(document.getElementById("daReceived").value);
  const hraReceived = parseFloat(document.getElementById("hraReceived").value);
  const totalRentPaid = parseFloat(document.getElementById("totalRentPaid").value);

  // Calculate total income
  const totalIncome = salaryIncome + otherIncome + interestIncome + rentalIncome;

  // Calculate deductions
  const totalDeductions = Math.min(deduction80C + contributionNPS + medicalInsurance, 150000);

  // Calculate taxable income
  const taxableIncome = totalIncome - totalDeductions;

  // Calculate HRA exemption (simple estimation)
  const hraExemption = Math.min(hraReceived * 0.10, totalRentPaid * 0.10, 0.50 * basicSalary);

  // Calculate tax payable (simplified)
  const taxPayable = taxableIncome * 0.20; // 20% tax for simplicity

  // Update UI with formatted values
  document.getElementById("taxableIncome").innerText = formatRupees(taxableIncome);
  document.getElementById("taxPayable").innerText = formatRupees(taxPayable);
  document.getElementById("totalDeductions").innerText = formatRupees(totalDeductions);
  document.getElementById("taxSavings").innerText = formatRupees(hraExemption);
}
</script>
