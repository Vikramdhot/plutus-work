...
<head>
    ...
    <meta name="keywords" content="fd calculator, fixed deposit calculator, fd interest calculator, fd interest rates calculator, fixed deposit interest calculator, fixed deposit interest rate calculator
">
    <meta name="description" content="FD Calculator lets you calculate your FD Return and Maturity amount based on the tenure. Plan your investment now with ICICI Bank FD Interest Calculator tool
">
    ...
    <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
    <title> Fixed Deposit Interest & Return Calculator
</title>
...
<body>
        ...
        <div class="container calculation_top">
            <div class="d-flex flex-column">
                <div class="d-flex  align-items-center common_links_service">
                    ...
                    <p>></p>
                    <a class="blod_text" href="#"> Fixed Deposit (FD) Calculator</a>
                </div>
                <div class="d-flex align-items-center calculator_head">
                    <h1 style="color:  rgba(66, 66, 65, 1);">Fixed Deposit (FD Calculator)</h1>
                </div>
            </div>
                ...
                <div class="input-section">
                    <div class="input-group">
                      ...
                      <div class="range_slide">
                        <input type="range" id="initialInvestment" min="0" max="1000000" step="1000" value="0">
                      </div>
                      <div class="range_input">
                        <input type="number" id="initialInvestmentInput" min="0" max="1000000" step="1000" value="0">
                      </div>
                    </div>
                    <div class="input-group">
                        <label for="monthlyContribution">Monthly Contribution (₹)</label>
                      <div class="range_slide">
                        <input type="range" id="monthlyContribution" min="0" max="50000" step="500" value="0">
                      </div>
                      <div class="range_input">
                        <input type="number" id="monthlyContributionInput" min="0" max="50000" step="500" value="0">
                      </div>
                    </div>
                    ...
                    <div class="input-group">
                      ...
                      <div class="range_slide">
                        <input type="range" id="investmentPeriod" min="1" max="35" step="1" value="0">
                      </div>
                      <div class="range_input">
                        <input type="number" id="investmentPeriodInput" min="1" max="35" step="1" value="0">
                      </div>
                    </div>

                    <div class="input-group">
                        <label for="rateOfReturn">Rate of Return (in % per annum)</label>
                      <div class="range_slide">
                        <input type="range" id="rateOfReturn" min="0" max="20" step="0.1" value="0">
                      </div>
                      <div class="range_input">
                        <input type="number" id="rateOfReturnInput" min="0" max="20" step="0.1" value="0">
                      </div>
                    </div>
            ...
            <div class="col-lg-6 cal_left_div">
                <div class="result-section">
                    <div class="brown_ful">
                      ...
                      <span id="totalContribution">₹ 0</span>
                    </div>
                    <div class="two_bomtm">
                      <div class="fadee">
                        <h2>Total Returns: </h2>
    ...
    const initialInvestmentBox = document.getElementById("initialInvestmentInput");
    const monthlyContributionInput = document.getElementById("monthlyContribution");
    const monthlyContributionBox = document.getElementById("monthlyContributionInput");
    const investmentPeriodInput = document.getElementById("investmentPeriod");
    const investmentPeriodBox = document.getElementById("investmentPeriodInput");
    const rateOfReturnInput = document.getElementById("rateOfReturn");
    const rateOfReturnBox = document.getElementById("rateOfReturnInput");
    ...
    function calculateFund() {
      ...
      const rateOfReturn = parseFloat(rateOfReturnInput.value);
  
      // Sync inputs
      initialInvestmentBox.value = initialInvestment;
      monthlyContributionBox.value = monthlyContribution;
      investmentPeriodBox.value = investmentPeriod;
      rateOfReturnBox.value = rateOfReturn;
  
      // Fund Calculation (Compound Interest Formula)
      let totalContribution = initialInvestment + (monthlyContribution * 12 * investmentPeriod);
      let totalReturns = 0;
      let totalValue = initialInvestment;
  
      for (let year = 1; year <= investmentPeriod; year++) {
        totalValue += monthlyContribution * 12;
        totalValue += totalValue * (rateOfReturn / 100);
      }
      totalReturns = totalValue - totalContribution;
  
      // Update Results
      document.getElementById("totalContribution").innerText = `₹ ${totalContribution.toLocaleString()}`;
    ...
    initialInvestmentInput.addEventListener("input", () => {
      initialInvestmentBox.value = initialInvestmentInput.value;
      calculateFund();
    });
    initialInvestmentBox.addEventListener("input", () => {
      initialInvestmentInput.value = initialInvestmentBox.value;
      calculateFund();
    });
  
    monthlyContributionInput.addEventListener("input", () => {
      monthlyContributionBox.value = monthlyContributionInput.value;
      calculateFund();
    });
    monthlyContributionBox.addEventListener("input", () => {
      monthlyContributionInput.value = monthlyContributionBox.value;
      calculateFund();
    });
  
    investmentPeriodInput.addEventListener("input", () => {
      investmentPeriodBox.value = investmentPeriodInput.value;
      calculateFund();
    });
    investmentPeriodBox.addEventListener("input", () => {
      investmentPeriodInput.value = investmentPeriodBox.value;
      calculateFund();
    });
  
    rateOfReturnInput.addEventListener("input", () => {
      rateOfReturnBox.value = rateOfReturnInput.value;
      calculateFund();
    });
    rateOfReturnBox.addEventListener("input", () => {
      rateOfReturnInput.value = rateOfReturnBox.value;
      calculateFund();
    });
