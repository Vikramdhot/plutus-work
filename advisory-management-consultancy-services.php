...
<head>
    ...
    <meta name="keywords" content="Litigation and assessment Corporate legal matters Compliance & regulatory filings Liquidation and winding up Compliance audits">
    <meta name="description" content="Stay compliant with our Compliance & Regulatory services, ensuring adherence to ever-evolving legal and regulatory requirements. Our expert team specializes in taxation, legal compliance, and corporate governance, offering tailored solutions to mitigate compliance risks and ensure regulatory compliance. From comprehensive compliance audits to seamless regulatory filings, we provide end-to-end support to help you navigate complex regulatory landscapes effectively. Trust us as your strategic partner in risk management and regulatory advisory, enabling you to maintain the highest standards of corporate compliance and governance.">
 ...
 <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
    ...
    <title>Plutus : advisory management consultancy services </title>
    <script>
          // Disable right-click
...
<?php
    ...
    <div class="overview-section section-padding">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="overview-image">
              <img src="assets/service5.webp" alt="image">
            </div>
          </div>
          <div class="col-lg-6">
            <div class="wrapp_service">
              <section class="service">
                  <div class="d-flex flex-column justify-content-center flex-wrap service-desc">
                    <ul>
                      <li>Taxation services</li>
                      <li>Litigation and assessment</li>
                      <li>Corporate legal matters</li>
                      <li>Compliance &amp; regulatory filings</li>
