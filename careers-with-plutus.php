...
<head>
  ...
  <meta name="keywords" content="Plutus Consulting, Careers, Job opportunities, Employment, Work with us, Career growth, Job openings, Professional development, Join our team, Work culture, Employee benefits, Talent retention">
<meta name="description" content="Explore career opportunities at Plutus Consulting. Join our team of experts and grow your career with us. Discover job openings, professional development opportunities, and our supportive work culture. Apply now and be part of a dynamic team.">
      ...
      <div class="container  d-flex justify-content-center justify-content-between align-items-center ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent" style="flex-grow: 0;">
              <ul class="navbar-nav me-auto mb-2  d-flex  align-items-center " style="gap: 2.5em;">
                  ...
                  <li class="nav-item">
                      <a href="about-plutus-consulting.html" style="color: #fff;">About us</a>
                  </li>
                   <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="vcfo-and-consulting-services.html">All Services</a></li>
                          <li>
                          ...
                          <li class="dropdown dropend">
                              ...
                              <ul class="dropdown-menu">
                                  <li><a class="dropdown-item" href="shared-cfo-services-for-businesses.html">  Shared CFO services</a></li>
                                  <li><a class="dropdown-item" href="Audit-support-and-audit-procedures.html"> Audit support and audit procedures</a></li>
                                  <li><a class="dropdown-item" href="limited-review-services.html"> Limited Reviews</a></li>
                                  <li><a class="dropdown-item" href="technology-implementation-solutions.html">Technology implementation</a></li>
                                  <li><a class="dropdown-item" href="sop-and-best-practices-development.html">SOP’s and best practices</a></li>
                          ...
                          <li class="dropdown dropend">
                              ...
                              <ul class="dropdown-menu">
                                  <li><a class="dropdown-item" href="business-process-implementation.html"> Implementation & processing</a></li>
                                  <li><a class="dropdown-item" href="litigation-support.html"> Litigation support</a></li>
                                  <li><a class="dropdown-item" href="labour-law-compliance-services.html"> Labour laws & compliance</a></li>
                                  <li><a class="dropdown-item" href="functional-outsourcing-solutions.html"> Function outsource</a></li>
                          ...
                          <li class="dropdown dropend">
                              ...
                              <ul class="dropdown-menu">
                                  ...
                                  <li><a class="dropdown-item" href="consulting-services-for-startups.html"> Startup consulting</a></li>
                          ...
                          <li class="dropdown dropend">
                              ...
                              <ul class="dropdown-menu">
                                  <li><a class="dropdown-item" href="corporate-taxation-services.html">Taxation services</a></li>
                                  <li><a class="dropdown-item" href="litigation-and-tax-assessment.html">  Litigation and assessment</a></li>
                                  <li><a class="dropdown-item" href="corporate-legal-matters.html">Corporate legal matters</a></li>
                                  <li><a class="dropdown-item" href="regulatory-compliance-filings.html"> Compliance & regulatory filings</a></li>
                                  <li><a class="dropdown-item" href="liquidation-winding-up.html"> Liquidation and winding up</a></li>
                                  <li><a class="dropdown-item" href="business-compliance-audits.html"> Compliance audits</a></li>
                              </ul>
                          </li>
                          <li>
                              <hr class="dropdown-divider">
                          ...
                          <li class="dropdown dropend">
                              ...
                              <ul class="dropdown-menu">
                                  ...
                                  <li><a class="dropdown-item" href="cxo-services-for-leadership.html">CXO services</a></li>
                                  <li><a class="dropdown-item" href="strategic-business-advisory.html">Strategic consulting & business advisory</a></li>
                                  <li><a class="dropdown-item" href="financial-and-legal-inspection.html"> Financial & legal health inspection</a></li>
                                  <li><a class="dropdown-item" href="india-market-entry-services.html"> India entry services</a></li>
                                  <li><a class="dropdown-item" href="business-process-outsourcing.html">Process outsourcing</a></li>
                              </ul>
                          </li>
                      </ul>
                  </li>
                  ...
                  <li class="nav-item active-nav">
                      <a class="nav-link" href="careers-with-plutus.php" style="color: #fff;">Career</a>
                  </li>
                  <li class="nav-item">
                       <a href="https://calendly.com/kunal-pc" target="_blank">
                          <button>
                              Book an Appointment
                          </button>
                      </a>
  ...
  <footer style="padding:0;">
    ...
    <div class="fotter_comman">
      <ul>
        ...
        <li><a class="active" href="careers-with-plutus.php">Career</a></li>
      </ul>
      </div>
