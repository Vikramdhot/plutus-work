...
<section id="webinar_content" class="resorces_content webinar_content">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="inner_resouces_list">
                    ...
                    <ul>
                        <li>
                            <div class="list_webnair">
                                <div class="list_image">
                                    <img src="assets/upcomin_1.png" alt="img">
                                </div>
                                <div class="list_content">
                                    <h2>Unifying Finance: How can MSMEs scale with Plutus</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                    <div class="list-btnn">
                                        <span>Sun, 24th Feb 2025  |  7 PM-8 PM</span>
                                        <a href="#">REGISTER NOW <svg width="13" height="12" viewBox="0 0 13 12"
                        ...
                        <li>
                            <div class="list_webnair">
                                <div class="list_image">
                                    <img src="assets/upcomin_2.png" alt="img">
                                </div>
                                <div class="list_content">
                                    <h2>Unifying Finance: How can MSMEs scale with Plutus</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                    <div class="list-btnn">
                                        <span>Sun, 24th Feb 2025  |  7 PM-8 PM</span>
                                        <a href="#">REGISTER NOW <svg width="13" height="12" viewBox="0 0 13 12" fill="none"
            ...
            <div class="col-sm-12">
                <div class="inner_resouces_list past-webinars">
                    <h3>past webinars</h3>
                    <ul>
                        <li>
                            <div class="list_webnair">
