...
<head>
    ...
    <meta name="keywords" content="national pension scheme calculator, new pension scheme calculator, national pension plan calculator, national pension scheme pension calculator, new pension scheme pension calculator, nps pension scheme calculator, retirement planner">
    <meta name="description" content="Discover the tools to shape your future with our powerful calculators. Plan your finances, investments, and more with precision and ease.">
    ...
    <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
    <title>Plan Your Future with Powerful Calculators</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="container calculator_top">
            <div class="d-flex flex-column">
                <div class="d-flex flex-column calculator_head">
                    <h1>Calculators</h1>
                    <p>Our range of financial calculators has been designed to make difficult calculations easier to comprehend and help you to make wise decisions with ease. Whether you're managing loans, planning investments, or calculating taxes, our tools ensure accuracy and clarity.
</p>
                </div>
                <div class="calculator_cards">
                    <a href="fd-calculator.html" class="cal_card">
                        <p>FD Calculator</p>
                        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="0.5" y="0.5" width="35" height="35" rx="17.5" stroke="currentColor" />
                            <path
                                d="M10.3561 24.8943L24.1447 11.1057M24.1447 11.1057L11.5759 10.9466M24.1447 11.1057L24.3038 23.6745"
                                stroke="currentColor" />
                        </svg>

                    </a>
                    <a href="income-tax-calculator.html" class="cal_card">
                    ...
                    <a href="mortgage-calculator.html" class="cal_card">
                    ...
                    <a href="ppf-calculator.html" class="cal_card">
                        <p>PPF Calculator</p>
                        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="0.5" y="0.5" width="35" height="35" rx="17.5" stroke="currentColor" />
                            <path
                    ...
                    <a href="rd-calculator.html" class="cal_card">
                        <p>RD Calculator</p>
                        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="0.5" y="0.5" width="35" height="35" rx="17.5" stroke="currentColor" />
                            <path
                    ...
                    <a href="sip-calculator.html" class="cal_card">
                        <p>SIP Calculator</p>
                        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="0.5" y="0.5" width="35" height="35" rx="17.5" stroke="currentColor" />
                            <path
