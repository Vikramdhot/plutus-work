...
<section id="WhitePapers_Case_Studies.html" class="whitepaper_studes">
    <div class="container">    
        <div class="whitepaper_head">
            <div class="whitepaper_head-inner">
        ...
        <div class="whitepaper_grid">
            <div class="whitepaper_grid_repeat">
                <div class="whitepaper_grid_image">
                    <img src="assets/case_study.png" alt="img">
                </div>
                <div class="whitepaper_grid_content">
                    <h2>Principles of Organizational Design & Optimization</h2>
                    <div class="date_download">
                        <span>24th Feb 2025</span>
                        <a href="#">DOWNLOAD <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.75 10.25V13.25C14.75 13.6478 14.592 14.0294 14.3107 14.3107C14.0294 14.592 13.6478 14.75 13.25 14.75H2.75C2.35218 14.75 1.97064 14.592 1.68934 14.3107C1.40804 14.0294 1.25 13.6478 1.25 13.25V10.25M4.25 6.5L8 10.25M8 10.25L11.75 6.5M8 10.25V1.25" stroke="#0041BE" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            </a>
                    </div>
                    </div>
